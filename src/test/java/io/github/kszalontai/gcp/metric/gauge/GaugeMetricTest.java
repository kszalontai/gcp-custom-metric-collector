...
public class GaugeMetricTest {
    ...
    public void assert_timeSeries_equals_for_bool_value() {
        ...
        GaugeMetric metric = Metric.gauge(CUSTOM_METRIC).value(BoolValue.TRUE).at(CUSTOM_METRIC_AT).build();
    ...
    public void assert_timeSeries_equals_for_double_value() {
        ...
        GaugeMetric metric = Metric.gauge(CUSTOM_METRIC).value(DoubleValue.of(value)).at(CUSTOM_METRIC_AT).build();
    ...
    public void assert_timeSeries_equals_for_long_value() {
        ...
        TimeSeries expectedTimeSeries = expected(valueBuilder);
        GaugeMetric metric = Metric.gauge(CUSTOM_METRIC).value(LongValue.of(value)).at(CUSTOM_METRIC_AT).build();
